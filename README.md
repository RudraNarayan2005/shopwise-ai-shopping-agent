...
The app works without an API key using deterministic recommendation logic. If you want LLM-enhanced wording, add this to `.env`:
...
- Product Document
- Technical Document
- Working public GitHub repository
- Demo video
